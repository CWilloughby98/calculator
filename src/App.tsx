  ...
  return (
    <div className='app'>
      <div className="calculator-grid">
        ...
        <button onClick={() => dispatch({type: ACTION.CLEAR})} className='all-clear span-two'>AC</button>
        ...
        <button className='equal span-two' onClick={() => dispatch({type: ACTION.EVALUATE})}>=</button>
      </div>
    </div>
  );
}
